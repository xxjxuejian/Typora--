...
![img](https://p1-jj.byteimg.com/tos-cn-i-t2oaga2asx/gold-user-assets/2018/9/26/166162c1cbad2c64~tplv-t2oaga2asx-zoom-in-crop-mark:3024:0:0:0.awebp)
...
根据我们的路由配置，当我访问 [http://localhost:8000/index](https://link.juejin.cn/?target=http%3A%2F%2Flocalhost%3A8000%2Findex) 时，就可以呈现出服务端渲染的结果了：

![img](https://p1-jj.byteimg.com/tos-cn-i-t2oaga2asx/gold-user-assets/2018/9/26/16615e831fa4c113~tplv-t2oaga2asx-zoom-in-crop-mark:3024:0:0:0.awebp)
...
其实是一个套路，我这里基于 [Vue SSR 指南](https://link.juejin.cn/?target=https%3A%2F%2Fssr.vuejs.org%2Fzh%2F%23%E4%BB%80%E4%B9%88%E6%98%AF%E6%9C%8D%E5%8A%A1%E5%99%A8%E7%AB%AF%E6%B8%B2%E6%9F%93-ssr-%EF%BC%9F) 中官方给出的例子为大家讲解 Vue 中的实现思路（思路见注释）。

该示例直接将 Vue 实例整合进了服务端的入口文件中：

```javascript
javascript
复制代码const Vue = require('vue')
// 创建一个express应用
