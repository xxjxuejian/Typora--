...
![img](https://p1-jj.byteimg.com/tos-cn-i-t2oaga2asx/gold-user-assets/2018/10/5/16642f37c7f20143~tplv-t2oaga2asx-zoom-in-crop-mark:3024:0:0:0.awebp)

大家留意一栏文章右侧可能会出现的图片，这里咱们给个特写：

![img](https://p1-jj.byteimg.com/tos-cn-i-t2oaga2asx/gold-user-assets/2018/10/5/16642f57149017c9~tplv-t2oaga2asx-zoom-in-crop-mark:3024:0:0:0.awebp)
...
![img](https://p1-jj.byteimg.com/tos-cn-i-t2oaga2asx/gold-user-assets/2018/10/5/16642f9403b5f320~tplv-t2oaga2asx-zoom-in-crop-mark:3024:0:0:0.awebp)

我们把代码提出来看一下：

```html
html
复制代码<div data-v-b2db8566="" 
    data-v-009ea7bb="" 
    data-v-6b46a625=""   
...
![img](https://p1-jj.byteimg.com/tos-cn-i-t2oaga2asx/gold-user-assets/2018/10/5/1664307daf51a16e~tplv-t2oaga2asx-zoom-in-crop-mark:3024:0:0:0.awebp)

我们看到，这个还没来得及被图片填充完全的网页，是用大大小小的空 div 元素来占位的。掘金首页也是如此。

一旦我们通过滚动使得这个 div 出现在了可见范围内，那么 div 元素的内容就会发生变化，呈现如下的内容：

![img](https://p1-jj.byteimg.com/tos-cn-i-t2oaga2asx/gold-user-assets/2018/10/5/1664300e3f14b7c9~tplv-t2oaga2asx-zoom-in-crop-mark:3024:0:0:0.awebp)

我们给 style 一个特写：

```html
html
复制代码style="background-image: url(&quot;https://p1-jj.byteimg.com/tos-cn-i-t2oaga2asx/gold-user-assets/2018/9/27/16619f449ee24252~tplv-t2oaga2asx-image.image;); background-size: cover;"
```
...
![img](https://p1-jj.byteimg.com/tos-cn-i-t2oaga2asx/gold-user-assets/2018/10/5/1664322fcf90be3e~tplv-t2oaga2asx-zoom-in-crop-mark:3024:0:0:0.awebp)
...
```javascript
javascript
复制代码const viewHeight = window.innerHeight || document.documentElement.clientHeight 
```
...
![img](https://p1-jj.byteimg.com/tos-cn-i-t2oaga2asx/gold-user-assets/2018/10/5/1664360c6ceda200~tplv-t2oaga2asx-zoom-in-crop-mark:3024:0:0:0.awebp)
