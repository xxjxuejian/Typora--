...
```javascript
javascript
复制代码const container = document.getElementById('container')
...
![img](https://p1-jj.byteimg.com/tos-cn-i-t2oaga2asx/gold-user-assets/2018/10/4/1663f57519a785ab~tplv-t2oaga2asx-zoom-in-crop-mark:3024:0:0:0.awebp)
