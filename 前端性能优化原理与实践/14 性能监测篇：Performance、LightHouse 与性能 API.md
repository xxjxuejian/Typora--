...
![img](https://p1-jj.byteimg.com/tos-cn-i-t2oaga2asx/gold-user-assets/2018/10/7/1664d6a13652f0db~tplv-t2oaga2asx-zoom-in-crop-mark:3024:0:0:0.awebp)
...
![img](https://p1-jj.byteimg.com/tos-cn-i-t2oaga2asx/gold-user-assets/2018/10/7/1664d6cba417ba48~tplv-t2oaga2asx-zoom-in-crop-mark:3024:0:0:0.awebp)

![img](https://p1-jj.byteimg.com/tos-cn-i-t2oaga2asx/gold-user-assets/2018/10/7/1664d6d61365b9fd~tplv-t2oaga2asx-zoom-in-crop-mark:3024:0:0:0.awebp)

### 简要分析

这里我打开掘金首页，选中 Performance 面板中的圆箭头，来看一下页面加载过程中的性能表现：

![img](https://p1-jj.byteimg.com/tos-cn-i-t2oaga2asx/gold-user-assets/2018/10/7/1664d714642f4dcb~tplv-t2oaga2asx-zoom-in-crop-mark:3024:0:0:0.awebp)

从上到下，依次为概述面板、详情面板。下我们先来观察一下概述面板，了解页面的基本表现：

![img](https://p1-jj.byteimg.com/tos-cn-i-t2oaga2asx/gold-user-assets/2018/10/7/1664d75451ddcd18~tplv-t2oaga2asx-zoom-in-crop-mark:3024:0:0:0.awebp)
...
![img](https://p1-jj.byteimg.com/tos-cn-i-t2oaga2asx/gold-user-assets/2018/10/7/1664d9d24ee5bd4e~tplv-t2oaga2asx-zoom-in-crop-mark:3024:0:0:0.awebp)
...
![img](https://p1-jj.byteimg.com/tos-cn-i-t2oaga2asx/gold-user-assets/2018/10/7/1664db3f31e0b6a6~tplv-t2oaga2asx-zoom-in-crop-mark:3024:0:0:0.awebp)
...
![img](https://p1-jj.byteimg.com/tos-cn-i-t2oaga2asx/gold-user-assets/2018/10/7/1664db9c661bfee3~tplv-t2oaga2asx-zoom-in-crop-mark:3024:0:0:0.awebp)

然后点击“Generate report”按钮，只需静候数秒，LightHouse 就会为我们输出一个完美的性能报告。

这里我拿掘金小册首页“开刀”：

![img](https://p1-jj.byteimg.com/tos-cn-i-t2oaga2asx/gold-user-assets/2018/10/7/1664dbdb110cb4ee~tplv-t2oaga2asx-zoom-in-crop-mark:3024:0:0:0.awebp)

稍事片刻，Report 便输出成功了，LightHouse 默认会帮我们打开一个新的标签页来展示报告内容。报告内容非常丰富，首先我们看到的是整体的跑分情况：

![img](https://p1-jj.byteimg.com/tos-cn-i-t2oaga2asx/gold-user-assets/2018/10/7/1664dc4798ee8992~tplv-t2oaga2asx-zoom-in-crop-mark:3024:0:0:0.awebp)

上述分别是页面性能、PWA（渐进式 Web 应用）、可访问性（无障碍）、最佳实践、SEO 五项指标的跑分。孰强孰弱，我们一看便知。

向下拉动 Report 页，我们还可以看到每一个指标的细化评估：

![img](https://p1-jj.byteimg.com/tos-cn-i-t2oaga2asx/gold-user-assets/2018/10/7/1664dc86aeeda780~tplv-t2oaga2asx-zoom-in-crop-mark:3024:0:0:0.awebp)
...
![img](https://p1-jj.byteimg.com/tos-cn-i-t2oaga2asx/gold-user-assets/2018/10/7/1664dd0337d66bfe~tplv-t2oaga2asx-zoom-in-crop-mark:3024:0:0:0.awebp)
...
![img](https://p1-jj.byteimg.com/tos-cn-i-t2oaga2asx/gold-user-assets/2018/10/7/1664dd8ec761f69f~tplv-t2oaga2asx-zoom-in-crop-mark:3024:0:0:0.awebp)

### 关键时间节点

在 performance 的 timing 属性中，我们可以查看到如下的时间戳：

![img](https://p1-jj.byteimg.com/tos-cn-i-t2oaga2asx/gold-user-assets/2018/10/7/1664dddde131e37a~tplv-t2oaga2asx-zoom-in-crop-mark:3024:0:0:0.awebp)

这些时间戳与页面整个加载流程中的关键时间节点有着一一对应的关系：

![img](https://p1-jj.byteimg.com/tos-cn-i-t2oaga2asx/gold-user-assets/2018/10/7/1664ddd4e3df9a14~tplv-t2oaga2asx-zoom-in-crop-mark:3024:0:0:0.awebp)

通过求两个时间点之间的差值，我们可以得出某个过程花费的时间，举个🌰：

```javascript
javascript
复制代码const timing = window.performance.timing
// DNS查询耗时
...
- [Performance 官方文档](https://link.juejin.cn/?target=https%3A%2F%2Fdevelopers.google.com%2Fweb%2Ftools%2Fchrome-devtools%2Fevaluate-performance%2Freference)
- [使用 Lighthouse 审查网络应用](https://link.juejin.cn/?target=https%3A%2F%2Fdevelopers.google.com%2Fweb%2Ftools%2Flighthouse%2F%3Fhl%3Dzh-cn)
- [MDN Performance API 介绍](https://link.juejin.cn/?target=https%3A%2F%2Fdeveloper.mozilla.org%2Fzh-CN%2Fdocs%2FWeb%2FAPI%2FPerformance)